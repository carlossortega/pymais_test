                                    ...
                                    <div class="card-body entry-details">
                                        ...
                                        <div class="single-progress">
                                            <div class="d-flex justify-content-between align-items-center mb-10">
                                                ...
                                                <p>{{ progress_bar($row->course_id) }}%</p>
                                            </div>
                                            <div class="progress" role="progressbar" aria-label="Basic example" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100">
                                                <div class="progress-bar" style="width: {{ progress_bar($row->course_id) }}%"></div>
                                            </div>
                                        </div>
                                        <a href="#" class="eBtn learn-btn w-100 text-center mt-20 f-500">{{ get_phrase('Continue Courses') }}</a>
                                    </div>
                                </div>
                            </div>
                        @endforeach
