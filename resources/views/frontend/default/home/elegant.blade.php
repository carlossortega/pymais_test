                ...
                <div class="col-md-6 order-2 order-md-1">
                    <div class="home1-banner-content">
                        ...
                        <div class="buttons d-flex align-items-center flex-wrap">
                            ...
                            <a data-bs-toggle="modal" data-bs-target="#promoVideo" href="#" class="border-btn1"><i class="fa-solid fa-play"></i>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="home1-section-title">
                        <h1 class="title mb-20">{{ get_phrase('Special Featured Course') }}</h1>
                        <p class="info">
                                ...
                                <div class="course-card1-details">
                                    ...
                                    <div class="course-card1-leasons-students d-flex align-items-center flex-wrap">
                                        <div class="leasons-students d-flex align-items-center">
                                            ...
                                            <p class="total">{{ lesson_count($row->id) }} {{ get_phrase('lesson') }}</p>
                                        </div>
                                        <div class="leasons-students d-flex align-items-center">
                                            <img src="{{ asset('assets/frontend/default/image/user-square.svg') }}" alt="">
                                            <p class="total">{{ course_enrollments($row->id) }} {{ get_phrase('Students') }}</p>
                                        </div>
                                    </div>
                                    <div class="course-card1-author-price d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="prices">
                                            @if (isset($row->discount_flag) && $row->discount_flag == 1)
                                                ...
                                                <p class="new-price">{{ currency(number_format($row->price - $row->discounted_price, 2)) }}</p>
        ...
        <div class="container">
            <div class="row">
                <div class="why-choose-area1">
                    <h2 class="title mb-30">{{ get_phrase('Why Choose Us') }}</h2>
                    @php
                    ...
                    <div class="why-choose-wrap1">
                        <div class="why-choose1-single">
                            <h1 class="total">{{ count($total_students) }} +</h1>
                            <p class="info">{{ get_phrase('Happy student') }}</p>
                        </div>
                        <div class="why-choose1-single">
                            <h1 class="total">{{ count($total_instructors) }} +</h1>
                            <p class="info">{{ get_phrase('Quality educators') }}</p>
                        </div>
                        <div class="why-choose1-single">
                            <h1 class="total">{{ count($premium_courses) }}+</h1>
                            <p class="info">{{ get_phrase('Premium courses') }}</p>
                        </div>
                        <div class="why-choose1-single">
                            <h1 class="total">{{ count($free_courses) }}+</h1>
    ...
    <section>
        <div class="container mb-80">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="home1-section-title">
                        <h1 class="title mb-20">{{ get_phrase('Top Rated Course') }}</h1>
                        <p class="info">
                            {{ get_phrase("Lorem Ipsum has been the industry's standard dummy text ever since the  unknown printer took a galley of type and scrambled") }}</p>
                    </div>
                </div>
                            ...
                            <div class="course-card1-inner">
                                ...
                                <div class="course-card1-details">
                                    <div class="rating-reviews d-flex align-items-center flex-wrap">
                                        ...
                                        <p class="reviews">({{ $row->review_count }} {{ get_phrase('Reviews') }})</p>
                                    </div>
                                    <div class="title-info">
                                        <h4 class="title">{{ ucfirst($row->title) }}</h4>
                                        <p class="info">{{ $row->short_description }}</p>
                                    ...
                                    <div class="course-card1-author-price d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="prices">
                                            @if (isset($row->discount_flag) && $row->discount_flag == 1)
                                                <p class="old-price">{{ currency(number_format($row->price, 2)) }}</p>
                                                <p class="new-price">{{ currency(number_format($row->price - $row->discounted_price, 2)) }}
                                                </p>
                                            @elseif (isset($row->is_paid) && $row->is_paid == 0)
                                                <p class="new-price">{{ get_phrase('Free') }}</p>
                                            @else
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="home1-section-title elegant-testimonial-title">
                        <h1 class="title mb-20">{{ get_phrase('What the people Thinks About Us') }}</h1>
                        <p class="info">
                            {{ get_phrase("Lorem Ipsum has been the industry's standard dummy text ever since the  unknown printer took a galley of type and scrambled") }}</p>
                    </div>
                </div>
                    ...
                    <div class="accordion qnaaccordion-one" id="accordionExample1">
                        ...
                        @foreach ($faqs as $key => $faq)
                            <div class="accordion-item">
                                ...
                                <div id="qnaOne{{ $key }}" class="accordion-collapse collapse {{ $key == 0 ? 'show' : '' }}" aria-labelledby="{{ $key }}" data-bs-parent="#accordionExample1">
        ...
        <section>
            <div class="container mb-60">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="home1-section-title">
                            <h1 class="title mb-20">{{ get_phrase('Our Latest Blog') }}</h1>
                            <p class="info">
                                {{ get_phrase("Lorem Ipsum has been the industry's standard dummy text ever since the  unknown printer took a galley of type and scrambled") }}</p>
                        </div>
                    </div>
                            ...
                            <a href="{{ route('blog.details', $blog->slug) }}" class="blog-post1-link">
                                <div class="blog-post1-inner">
                                    ...
                                    <div class="blog-post1-details">
                                        <h3 class="title mb-3 pt-2">{{ ucfirst($blog->title) }}</h3>
