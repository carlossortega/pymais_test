                ...
                @foreach (App\Models\Category::take(5)->get() as $category)
                    <div class="col">
                        <a href="{{ route('courses', $category->slug) }}">
                            ...
                            <p class="subtitle-4 fs-15px lh-23px">{{ count_category_courses($category->id) }}</p>
                        </a>
                    </div>
                @endforeach
            </div>
                                        ...
                                        <div class="d-flex align-items-center gap-2 justify-content-between flex-wrap mb-2">
                                            <div class="mk-card-price d-flex align-items-end gap-1 ">
                                                @if (isset($row->discount_flag) && $row->discount_flag == 1)
                                                    <p class="title-4 fs-20px lh-26px fw-bold">{{ currency(number_format($row->price - $row->discounted_price, 2)) }}
                                                    </p>
                    ...
                    <div class="col-lg-5 col-md-6">
                        <div class="video-banner-area1">
                            @if (isset($instructor->image))
                                <img src="{{ asset('assets/upload/home_page_image/marketplace/' . $instructor->image) }}" alt="">
                    ...
                    <div class="accordion qnaaccordion-four" id="accordionExample4">
                        ...
                        @foreach ($faqs as $key => $faq)
                            <div class="accordion-item">
                                ...
                                <div id="qnaOne{{ $key }}" class="accordion-collapse collapse {{ $key == 0 ? 'show' : '' }}" data-bs-parent="#accordionExample4" aria-labelledby="{{ $key }}">
                    ...
                    <div class="swiper lms-testimonial-2">
                        <div class="swiper-wrapper">
                            ...
                            @foreach ($reviews as $review)
                                @php
                                    $userDetails = App\Models\User::where('id', $review->user_id)
                                        ->firstOrNew();
                                @endphp
                                <div class="swiper-slide">
                    ...
                    <div class="col-lg-7">
                        <div class="subscribe-area-1">
                            <h3 class="title-4 fs-28px lh-36px fw-bold text-center text-white mb-14px">
                                {{ get_phrase("Subscribe to stay tuned for new web design and latest updates. Let's do it! ") }}</h3>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="max-sm-350px">
                                ...
                                <a href="{{ route('blog.details', $blog->slug) }}" class="mk-blog-body">
                                    <div class="lms-1-card rounded-3">
                                        <div class="lms-1-card-body">
                                            <h3 class="title-4 fs-18px lh-26px fw-semibold mb-14px">{{ ucfirst($blog->title) }}</h3>
                                            <p class="subtitle-4 fs-15px lh-24px mb-18px ellipsis-line-3">{{ ellipsis(strip_tags($blog->description), 160) }}</p>
