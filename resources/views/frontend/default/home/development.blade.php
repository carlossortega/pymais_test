                    ...
                    <div class="col-lg-6">
                        <div class="software-development-banner">
                            @if (isset($stordetails->image))
                                <img src="{{ asset('assets/upload/home_page_image/development/' . $stordetails->image) }}" alt="">
                            @else
                    ...
                    <div class="col-lg-6">
                        <div class="software-development-details">
                            ...
                            <a href="{{ route('about.us') }}" class="btn-black-arrow1">
                                ...
                                <img src="{{ asset('assets/frontend/default/image/arrow-circle-white-20.svg') }}" alt="">
                            </a>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row row-20 mb-100 justify-content-center">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="learning-coding-card">
                                ...
                                <div class="dev-course-card-body">
                                    ...
                                    <div class="reviews d-flex align-items-center">
                                        @if ($review_count > 0)
                                            ...
                                            <p class="total">{{ $review_count }} {{ get_phrase('Reviews') }}</p>
                                        @endif
                                    </div>
                                    ...
                                    <div class="leason-student d-flex align-items-center">
                                        <div class="leasons-students d-flex align-items-center">
                                            ...
                                            <p class="total">{{ lesson_count($row->id) }}{{ get_phrase('lessons') }}</p>
                                        </div>
                                        <div class="leasons-students d-flex align-items-center">
                                            <img src="{{ asset('assets/frontend/default/image/book-open-16.svg') }}" alt="">
