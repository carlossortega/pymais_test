                        ...
                        <a href="{{ route('course.details', $row->slug) }}" class="d-block h-100 w-100 max-sm-350px">
                            <div class="lms-1-card rounded-4 rounded-4 lms-card-hover1">
                                <div class="lms-1-card-body">
                                    ...
                                    <div>
                                        <h5 class="title-3 fs-18px lh-26px fw-medium mb-10px">{{ ucfirst($row->title) }}</h5>
                                        ...
                                        <div class="kg-card-profile-price d-flex align-items-center justify-content-between flex-wrap gap-2">
                                            ...
                                            @if (isset($row->discount_flag) && $row->discount_flag == 1)
                                                <h4 class="price title-1 fs-20px lh-26px fw-bold">{{ currency(number_format($row->price - $row->discounted_price, 2)) }}</h4>
                                ...
                                <div class="lms-1-card-body">
                                    <div class="d-flex align-items-center gap-20px">
                                        ...
                                        <div>
                                            ...
                                            <p class="subtitle-2 fs-15px lh-23px fw-medium">{{ count_category_courses($category->id) }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="community-banner1">
                            @if (isset($stordetails->image))
                                <img src="{{ asset('assets/upload/home_page_image/kindergarden/' . $stordetails->image) }}" alt="">
                            @else
    ...
    <section>
        <div class="container">
            <div class="row gx-0 gy-4 align-items-end mb-50px">
                ...
                <div class="col-xl-8">
                    <div class="swiper lms-testimonial-1">
