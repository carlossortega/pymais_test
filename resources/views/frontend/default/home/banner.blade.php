    ...
    <div class="row">
        <div class="col-md-6">
            <div class="banner-content">
                ...
                @endphp
                <h5 class="d-flex"><img src="{{ asset('assets/frontend/default/image/roket.svg') }}" alt="...">
                    {{ get_phrase('The Leader in online learning') }}</h5>
                <h1>{{ $phrase_one }} <span class="gradient color shadow-none">{{ $phrase_two }}</span></h1>
