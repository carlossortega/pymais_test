                ...
                <div class="card-body pt-2">
                    ...
                    <form action="#">
                        <div class="mb-3">
                            ...
                            <textarea name="certificate_element_content" placeholder="{{ get_phrase('Total Lesson') }}:{number_of_lesson}" id="certificate_element_content" rows="3"
                                class="form-control"></textarea>
                        </div>
                        <div class="mb-3">
                            <label for="font_family_default" class="form-label">{{ get_phrase('Choice a font-family') }}</label><br>
                            <input type="radio" name="font_family" value="default" id="font_family_default" checked> <label
                                for="font_family_default">{{ get_phrase('Default') }}</label><br>
                            <input type="radio" name="font_family" value="Pinyon Script" id="font_family_pinyon_script"> <label
    ...
    <script>
        ...
        function addElemToCertificate() {
            ...
            if (certificate_element_content != '') {
                ...
                $("#font_size").val(16);
                $("#font_family_default").attr('checked', 'checked');
                initialize();
            }
        }
