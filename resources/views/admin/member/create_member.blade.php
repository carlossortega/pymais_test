...
@push('title', get_phrase('Create Member'))
...
@section('content')
        ...
        <div class="ol-card-body my-3 py-12px px-20px">
            <div class="d-flex align-items-center justify-content-between gap-3 flex-wrap flex-md-nowrap">
                <h4 class="title fs-16px">
                    ...
                    {{ get_phrase('Create Member') }}
                </h4>

                <a href="{{ route('admin.member.index') }}" class="btn ol-btn-outline-secondary d-flex align-items-center cg-10px">
    ...
    <div class="ol-card p-4">
        <h4 class="title fs-16px mb-20px">{{ get_phrase('Member Info') }}</h4>
