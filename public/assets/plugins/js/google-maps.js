  ...
  if ($(".map-canvas").length) {
    $(".map-canvas").each(function () {
      ...
      if ($(this).hasClass("skin1")) {
        var iconPath =
          "https://creativelayers.net/themes/findhouse-html/images/resource/map-marker.png";
        var styles = [
          {
            featureType: "all",
            elementType: "labels.text",
      ...
      if ($(this).hasClass("skin2")) {
        var iconPath = "./assets/images/ongoing-project-map/map-pin.svg";
        var styles = [
          {
            featureType: "all",
            elementType: "labels",
      ...
      if (iconPath) {
        map.addMarker({
          ...
          infoWindow: {
            content:
              '<img src="./assets/images/ongoing-project-map/1.png" alt="fp1.jpg"/> <h4>BuildUp Lake View Haven - Mohakhali DOSH</h4> <p><i class="fi fi-sr-land-layer-location"></i>Mohakhali DOSH, Dhaka, Bangladesh</p><a href="#">View project<i class="fi-rr-arrow-right"></i></a>',
          },
        });
        map.addMarker({
          icon: iconPath,
